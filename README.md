...
#Tutorial 02 - Stream Adventure
**Learn how to compose streaming interfaces with .pipe()**

###About the Author###
This tutorial was written by [James Halliday](https://github.com/substack). If you find this tutorial helpful and you'd like to say thanks to James, why not [make a small donation here?](https://www.gittip.com/substack)
...
- Hands Dirty: open up a Terminal with from the 'Tools->Terminal' menu, then enter `npm install -g stream-adventure`.
- Lazy Way: click on the "Install Stream Adventure" menu item. Once installed, you can close that tab.
...
You can open a Terminal window at any time by selecting the 'Tools->Terminal' menu item. Your terminal defaults to the `~/workspace` folder, which equates to the root of your Codio code project. If you are writing your code in the lesson folder (for example `02_meet_pipe`) then you will need to `cd` into that folder, so something like this

    cd 02_meet_pipe
    node meet_pipe.js 1 2 3
